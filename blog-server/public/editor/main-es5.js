...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 6,
      vars: 0,
      consts: [[1, "container"], [1, "row"], [1, "col"], ["id", "list-component"]],
  ...
  function srcAppBlogServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var BlogService = /*#__PURE__*/function () {
      ...
      _createClass(BlogService, [{
        ...
        key: "getLocalPostsObservable",
        value: function getLocalPostsObservable() {
  ...
  function srcAppEditEditComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    EditComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 23,
      vars: 8,
      consts: [[2, "text-align", "left", "margin-bottom", "20px"], ["type", "text", "placeholder", "Write the title of your post here...", 3, "ngModel", "ngModelChange"], [2, "text-align", "left"], ["placeholder", "Write the body of your post here...", 3, "ngModel", "ngModelChange"], ["id", "buttons"], [3, "disabled", "click"], [3, "click"]],
      template: function EditComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditComponent_Template_button_click_17_listener() {
            return ctx.savePost();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditComponent_Template_button_click_21_listener() {
  ...
  function srcAppListListComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function ListComponent_li_4_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        var tmp_0_0 = null;
        var currVal_0 = p_r1.postid == ((tmp_0_0 = ctx_r0.blogService.getCurrentDraft()) == null ? null : tmp_0_0.postid);
      ...
      _createClass(ListComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.blogService.updateLocalPosts().then(function () {
            _this10.blogService.getLocalPostsObservable().subscribe(function (res) {
              _this10.posts = res;

              for (var i = 0; i < _this10.posts.length; i++) {
                console.log(_this10.posts[i].postid);
              }
            });
          });
        }
  ...
  function srcAppPreviewPreviewComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    PreviewComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 1,
      vars: 1,
      consts: [[4, "ngIf"], [3, "click"], ["id", "preview", 3, "innerHTML"]],
